package ar.utn.frc.pixel.perfect.bonvino.interfaz;
import java.text.ParseException;
import java.text.SimpleDateFormat;
import java.util.Date;
import javax.swing.JOptionPane;
import ar.utn.frc.pixel.perfect.bonvino.negocio.ControladorGenerarReporte;
...
public class VentanaGenerarReporte extends javax.swing.JFrame {
     ...
     */
    public VentanaGenerarReporte(ControladorGenerarReporte controlador) {
        initComponents();
        this.controlador = controlador;
    }
    
    public void setControlador(ControladorGenerarReporte controlador) {
        this.controlador = controlador;
    }
